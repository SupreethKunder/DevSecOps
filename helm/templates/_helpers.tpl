...
*/}}
{{- define "devops.name" -}}
{{- printf "%s-%s" .Values.nameOverride .Values.env | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- printf "%s-%s" .Values.fullnameOverride .Values.env | trunc 63 | trimSuffix "-" }}
{{- else }}
